    ...
    return product ? (
        <div className="mt-12 mb-20">                                                                                       
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={()=> {addToCart(product._id); navigate("/cart")}} className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primary-light transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm-grid-cols-3 md:grid-cols-4 gap-6 md:gap-70 lg:grid-cols-5
                mt-6 w-full">
