...
const InputField = ({ type, placeholder, name, handleChange, address})=>(
    <input className='w-full px-2 py-2.5 border border-gray-500/30 rounnded outline-none text-gray-500 
            ...
            <div className='flex-1 max-w-md '>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField handleChange={handleChange} address={address}
                        ...
                        <button className='w-full bg-primary text-white py-3 hover:bg-primary-light 
